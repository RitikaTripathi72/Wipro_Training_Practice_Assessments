...
//	            renderContactList(out, CONTACT_STORE.values());
...
//	                response.sendRedirect(request.getContextPath() + "/ContactManagerServlet/view");
//	                return;
//	            } else {
...
//	                out.println("<a href='view' class='text-blue-600 hover:underline mt-4 block'>Go back to list</a>");
//	                out.println("</div>");
//	                renderFooter(out);
//	                return;
//	            }
...
//	    }
//	    
//	    private void renderContactList(PrintWriter out, Collection<Contact> contacts) {
...
//	        out.println("    <a href='add' class='bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300 transform hover:scale-105'>+ Add New Contact</a>");
//	        out.println("</div>");
//
...
//	    }
//	    
//	    private void renderAddForm(PrintWriter out) {
...
//	        
//	        // The form submits back to the same path (/add) but uses POST to trigger doPost
//	        out.println("    <form action='add' method='POST' class='space-y-6'>");
//	        
//	        // Name Field
//	        out.println("        <div>");
...
//	        out.println("            <a href='view' class='text-center py-3 px-6 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition duration-150'>Cancel</a>");
